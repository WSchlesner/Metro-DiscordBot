...
var GotHttpClient = /** @class */ (function () {
    function GotHttpClient(auth, client) {
        if (client === void 0) { client = exports.httpClient; }
        this.auth = auth;
        this.client = client;
    }
    ...
    GotHttpClient.prototype.populateContext = function (options, contextOverride) {
        ...
        if (options && (context === null || context === void 0 ? void 0 : context.authorization) && context.authorization instanceof types_1.Authorization) {
            options.headers = __assign(__assign({}, options.headers), { Authorization: context.authorization.asHeader() });
        }
        return options;
    };
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        return [4 /*yield*/, ((_c = this.auth) === null || _c === void 0 ? void 0 : _c.provide())];
                    case 4:
...
function fromHttpError(error, auth) {
    ...
    if (response.statusCode === 403 && errorMessage(response) === 'expired-token') {
        return new types_1.TokenExpired(error.request.requestUrl, {
            type: auth.type,
            token: auth.token,
